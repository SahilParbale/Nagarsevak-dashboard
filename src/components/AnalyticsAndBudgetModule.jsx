...
export default function AnalyticsAndBudgetModule() {
  return (
    <div className="flex flex-col gap-8 h-full animate-slide-in pb-8">
      <div className="flex items-center gap-3 border-b border-slate-200 pb-4">
         <div className="p-3 rounded-xl bg-purple-100 text-purple-600 shadow-sm">
            <BarChart3 size={28} />
         </div>
         <div>
           <h2 className="text-2xl font-black text-slate-800 uppercase tracking-wider">Analytics & Budget</h2>
