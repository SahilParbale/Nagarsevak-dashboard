  ...
  return (
    <div className="flex flex-col gap-8 h-full animate-slide-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
        <div className="glass-card p-6 flex items-center justify-between hover:shadow-md transition-shadow">
          <div>
            ...
            <h3 className="text-3xl font-black text-slate-800">3<span className="text-lg text-slate-400 font-medium ml-1">/ 4</span></h3>
          </div>
        ...
        <div className="glass-card p-6 flex items-center justify-between hover:shadow-md transition-shadow">
          <div>
            ...
            <h3 className="text-3xl font-black text-emerald-600">35</h3>
          </div>
        ...
        <div className="glass-card p-6 flex items-center justify-between hover:shadow-md transition-shadow bg-gradient-to-br from-rose-50 to-white border-rose-100">
          <div>
            ...
            <h3 className="text-3xl font-black text-rose-700">2</h3>
          </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
        ...
        <div className="glass-card p-8 flex flex-col h-full bg-gradient-to-br from-rose-50 to-white border border-rose-100 shadow-sm">
        ...
        <div className="glass-card p-8 xl:col-span-2 flex flex-col h-full">
